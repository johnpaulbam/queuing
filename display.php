		...
		<div class="card" >
			<div class="card-body" >
				<div class="container-fluid" >
					<div class="card" >
							<center><div style="background:#FFDF00; "><h4 style="color:black;" ><b ><?php echo strtoupper($tname) ?></b></h4></div></center>
						</div>
						<br>
					<div class="card" >
						<div style="background:#FFDF00; "><h3 class="text-center" ><b>Now Serving</b></h3></div>
						<div class="card-body" >
